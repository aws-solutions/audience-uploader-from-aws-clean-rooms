...
echo "------------------------------------------------------------------------------"
echo "[Packing] Unit tests Script"
echo "------------------------------------------------------------------------------"
...
echo 'rm -rf "$dist_dir"/source/snap_setup/snapchat_credentials.json'
rm -rf "$dist_dir"/source/snap_setup/snapchat_credentials.json
echo 'rm -rf "$dist_dir"/source/tests/coverage-reports'
rm -rf "$dist_dir"/source/tests/coverage-reports
echo 'rm -rf "$dist_dir"/source/cdk_solution_helper_py/helpers_common/build'
rm -rf "$dist_dir"/source/cdk_solution_helper_py/helpers_common/build
