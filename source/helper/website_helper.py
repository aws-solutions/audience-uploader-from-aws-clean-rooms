...
#   deployment/uploader-from-clean-rooms-web.yaml.
#
###############################################################################
...
def copy_source(event, context):
    try:
        ...
        target_platform = event["ResourceProperties"]["TargetPlatform"]
        ...
        try:
            ...
            try:
                ...
                new_variables = {"API_ENDPOINT": api_endpoint, "AWS_REGION": region, "USER_POOL_ID": user_pool_id, "USER_POOL_CLIENT_ID": client_id, "IDENTITY_POOL_ID": identity_id, "DATA_BUCKET_NAME": data_bucket_name, "ARTIFACT_BUCKET_NAME": artifact_bucket_name, "TARGET_PLATFORM": target_platform}
                LOGGER.info(
